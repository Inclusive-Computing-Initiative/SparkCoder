    ...
    return (
        ...
        <div className="page" style={{paddingTop:"15%",}}>
            ...
            <div style={{marginTop: "-12%", textAlign: "center"}}>
                ...
                <p style={{fontSize: "29px", letterSpacing: "2px", fontWeight: "300", marginTop: "-2%"}}>We'd love to hear your feedback!</p>
                <Button
                    variant="contained"
                    sx={{
                        borderRadius: 3,
                ...
                <p style={{fontSize: "24px", marginTop: "10%"}}> Visit our website: <a href="https://www.inclusivecompute.org/">https://www.inclusivecompute.org/</a></p>
            </div>
        </div>
        </>
    );
