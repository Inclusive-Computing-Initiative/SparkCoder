...
export default function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <Footer />
      <a style={{fontSize: "12px"}} href="https://freepik.com/free-vector/tiny-graphic-designer-drawing-with-big-pen-computer-screen-creators-work-creative-woman-working-laptop-flat-vector-illustration-digital-design-concept-banner-landing-web-page_28480869.htm"><p style={{marginLeft: "2%", letterSpacing: "1.5px"}}>CREDITS: Image by pch.vector on Freepik</p></a>
    </BrowserRouter>
  );
}
